...
<div class="container page__container" id="app">
    <div class="row">
        <div class="col-md-12">
            <h1 class="bold">Welcome to our courses </h1>
            <img width="100%" src="{{ asset('learningAssets/images/course.png') }}" alt="Course Cap">
            <h2 class="bold p-5 text-center" style="width:100%; height:50px;"><i class="material-icons bold" style="font-size: 40px;">library_books</i>&nbsp;Courses</h2>
        </div>
    </div>
