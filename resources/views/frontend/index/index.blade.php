...
<div class="home-banner text-white mb-4">
    <div class="container page__container">
        <h1 class="display-4 bold" data-aos="fade-up" data-aos-duration="800">Everything you need to LEARN is training</h1>
        <p class="lead mb-5" data-aos="fade-up" data-aos-duration="1000">Get your free courses right now, browse the courses</p>
        <div data-aos="fade-down" data-aos-duration="400" data-aos-delay="400" data-offset="-100">
            <a class="btn btn-light btn-lg mr-1" href="{{ route('courses') }}">Browse Courses</a>
            <a class="btn btn-success btn-lg" href="{{ route('topics') }}">Topics</a>
        </div>
    </div>
</div>
@endsection
...
<div class="container page__container" id="app">
    <h2 class="bold m-4 text-center p-6">Courses</h2>
